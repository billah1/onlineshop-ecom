    ...
    <div class="color-switcher-inner">
        ...
        <div class="switcher-panel-item bg">
            ...
            <ul class="nav flex-wrap bgbody-style bg-pattern">
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-pettern/1.png" alt="Pettern"></li>
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-pettern/2.png" alt="Pettern"></li>
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-pettern/3.png" alt="Pettern"></li>
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-pettern/4.png" alt="Pettern"></li>
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-pettern/5.png" alt="Pettern"></li>
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-pettern/6.png" alt="Pettern"></li>
            </ul>
        </div>
        ...
        <div class="switcher-panel-item bg">
            ...
            <ul class="nav flex-wrap bgbody-style bg-img">
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-img/01.jpg" alt="Images"></li>
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-img/02.jpg" alt="Images"></li>
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-img/03.jpg" alt="Images"></li>
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-img/04.jpg" alt="Images"></li>
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-img/05.jpg" alt="Images"></li>
                <li><img src="{{ asset('assets/frontend') }}/img/bg-panel/bg-img/06.jpg" alt="Images"></li>
            </ul>
        </div>
    </div>
</div>
