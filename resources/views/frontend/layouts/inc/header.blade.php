            ...
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <div class="brand-logo">
                        <a href="index.html">
                            <img src="{{ asset('assets/frontend') }}/img/logo/logo.png" alt="brand logo">
                        </a>
                    </div>
                </div> <!-- end logo area -->
                <div class="col-lg-9">
                        ...
                        <div class="header-middle-block">
                            ...
                            <div class="header-mini-cart">
                                ...
                                <ul class="cart-list">
                                    <li>
                                        <div class="cart-img">
                                            <a href="product-details.html"><img src="{{ asset('assets/frontend') }}/img/cart/cart-1.jpg"
                                                    alt=""></a>
                                        </div>
                                        <div class="cart-info">
                                    ...
                                    <li>
                                        <div class="cart-img">
                                            <a href="product-details.html"><img src="{{ asset('assets/frontend') }}/img/cart/cart-2.jpg"
                                                    alt=""></a>
                                        </div>
                                        <div class="cart-info">
